      ...
      <div className="grid grid-cols-1 gap-x-4 gap-y-5 px-4 pt-5 pb-5 md:grid-cols-3 md:px-8">
        ...
        <div className="flex items-center justify-center gap-4 md:justify-end">
          ...
          <a
            ...
            rel="noopener noreferrer"
            title="Taceo on X"
            href="https://x.com/TACEO_IO"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="11" fill="none">
              <g clipPath="url(#x)">
                <path
                  fill="#737373"
                  d="M10.735.05h1.98L8.387 4.47l5.09 6.017H9.492l-3.12-3.648L2.8 10.487H.82l4.626-4.728L.564.05H4.65l2.821 3.335L10.735.05Zm-.695 9.377h1.097L4.053 1.055H2.876l7.164 8.372Z"
                />
              </g>
              <defs>
                <clipPath id="x">
