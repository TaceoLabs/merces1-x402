...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`${collapsed ? "w-14" : "w-64"} shrink-0 sticky top-0 h-screen flex flex-col border-r border-zinc-200 bg-[#f9f8f5] transition-[width] duration-200 overflow-hidden`}
    >
      {/* Logo */}
