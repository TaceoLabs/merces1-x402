...
const LINKS = [
  {
    ...
    label: 'Introduction',
    description:
      'Understand the confidential x402 protocol — how payments settle onchain while amounts stay hidden.',
    icon: (
      <svg
  ...
  },
  {
    ...
    label: 'Client',
    description:
      'Connect a wallet, claim testnet USDC from the faucet, and pay for access to a protected resource.',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
  ...
  },
  {
    ...
    description:
      "See the server's payment history, revenue stats, and pricing tier breakdown with and without Confidential x402.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
        ...
        <main className="flex-1 flex flex-col justify-center px-6 py-20 gap-12">
          ...
          <div className="text-center max-w-xl mx-auto">
            ...
            <p className="text-base text-zinc-500 leading-relaxed">
              Confidential x402 is a privacy extension to the x402 payment protocol that hides
              payment amounts from public view while keeping the full payment flow onchain and
              verifiable.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-3xl mx-auto">
            {LINKS.map(({ href, label, description, icon }) => (
              ...
              >
                ...
                <div>
                  <div className="text-sm font-semibold text-zinc-900 mb-1 group-hover:text-[#192b25] transition-colors">
                    {label}
                  </div>
