        ...
        <main className="flex-1 flex flex-col px-6 py-12">
          <div className="w-full max-w-4xl mx-auto flex flex-col gap-8">
              ...
              <div>
                ...
                <div className="mt-3 border-l-4 border-zinc-300 bg-zinc-100 px-4 py-2.5 rounded-r-md">
                  ...
                  <p className="text-sm text-zinc-600">
                    The API provider always has full visibility into payment details regardless of
                    which x402 mode is used.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-base text-zinc-500 leading-relaxed mb-3">
                A full log of every x402 payment received by this server. In confidential mode,
                amounts and price tiers are never exposed onchain, but the server can track them
                directly.
              </p>
              <div className="flex justify-center mb-4 md:hidden">
                <X402ModeToggle mode={x402Mode} onChange={setX402Mode} />
